        ...
        <div class="row col-12 mt-4">
            <div class="col-lg-6">
                <select class="form-select" name="position" id="position" required="required">
                    <option value="" disabled selected>Poste recherché</option>
        ...
        <div class="row col-12 mt-3">
            ...
            <div class="col-lg-3">
                <select class="form-select" name="contract" id="contract">
                    <option value="" disabled selected>Type de contrat souhaité</option>
            ...
            <div class="col-lg-3">
                <input class="form-control" type="number" name="salary" id="salary" required="required" placeholder="Salaire souaité (brut)">
            </div>
        </div>
        <div class="row mt-3">
            <div class="col-lg-12">
